...
export default function SignatureInvitation({
  ...
  return (
    <Html>
      <Head />
      <Preview>Review and sign {documentName}</Preview>
      <Tailwind>
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 w-[465px] p-5">
            ...
            <Text className="text-sm leading-6 text-black">
              ...
              has requested your signature on the document: <span className="font-semibold">{documentName}</span>.
            </Text>
            ...
            <Footer footerText="This is a secure signature request sent via Dossier." />
          </Container>
        </Body>
      </Tailwind>
    </Html>
