...
import { TeamContextType } from "@/features/workspace/providers/workspace-provider";
import {
  DndContext,
  DragEndEvent,
  DragOverEvent,
...
import { moveDataroomDocumentToFolder } from "@/shared/utils/documents/move-dataroom-documents";
import { moveDataroomFolderToFolder } from "@/shared/utils/documents/move-dataroom-folders";
import { useDataroomPermissions } from "@/shared/utils/hooks/use-dataroom-permissions";
import {
...
import useDataroomPermissionGroups from "@/shared/utils/swr/use-dataroom-permission-groups";
import { useMediaQuery } from "@/shared/utils/utils/use-media-query";

import { useRemoveDataroomItemsModal } from "@/shared/ui/datarooms/actions/remove-document-modal";
import DataroomDocumentCard from "@/shared/ui/datarooms/dataroom-document-card";
import {
  SetUnifiedPermissionsModal,
  type UnifiedPermissionItem,
} from "@/shared/ui/datarooms/groups/set-unified-permissions-modal";
import { useDeleteFolderModal } from "@/shared/ui/documents/actions/delete-folder-modal";
import { DraggableItem } from "@/shared/ui/documents/drag-and-drop/draggable-item";
import { DroppableFolder } from "@/shared/ui/documents/drag-and-drop/droppable-folder";
import { EmptyDocuments } from "@/shared/ui/documents/empty-document";
import FolderCard from "@/shared/ui/documents/folder-card";
...
import {
  useUploadCallbacks,
  useUploadProgress,
} from "@/features/files/upload/upload-progress-context";

import UploadZone from "@/shared/ui/upload-zone";
