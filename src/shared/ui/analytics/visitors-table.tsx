...
import { durationFormat, fetcher, timeAgo } from "@/shared/utils/utils";
import { downloadCSV } from "@/shared/utils/utils/csv";
...
import { DataTablePagination } from "@/shared/ui/visitors/data-table-pagination";
...
export default function VisitorsTable({
  ...
  const { data } = useSWR<{ visitors: Visitor[] }>(
